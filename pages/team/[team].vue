      ...
      <div v-if="teamStats && !loading">
        <div class="grid">
          ...
          >
            ...
            <Divider></Divider>
            <div class="font-bold text-lg m-3">Havoc</div>
            <DataTable
              :value="havocMetrics"
              :rows="3"
              class="p-datatable-small"
          ...
          <div class="col-12 md:col-6" v-if="hasPlayerData">
            ...
            >
              <Column field="name" header="Player" sortable> </Column>
              ...
              <Column
                field="usage.standardDowns"
                header="Standard Downs"
                class="text-center"
                headerClass="center-header"
                sortable
              >
              ...
              <Column
                field="usage.passingDowns"
                header="Passing Downs"
                class="text-center"
                headerClass="center-header"
                sortable
              >
...
const getColumnFormatting = (label: string, value: number, defense = false) => {
  ...
  switch (label) {
    ...
    case 'Total Havoc':
      reversed = !defense;
      thresholds = [0.07, 0.21];
      break;
    case 'Front Seven Havoc':
      reversed = !defense;
      thresholds = [0.035, 0.135];
      break;
    case 'DB Havoc':
      reversed = !defense;
    ...
    case 'Standard Downs Success':
      thresholds = [0.44, 0.52];
      break;
    case 'Passing Downs Success':
      thresholds = [0.28, 0.38];
      break;
    case 'Explosiveness':
