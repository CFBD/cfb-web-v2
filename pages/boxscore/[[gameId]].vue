<template>
    <Card class="text-center m-3">
        ...
        <template #content>
            <GameSearch v-model="selectedGameId" clearOnSelection @selection="selectGame"></GameSearch>
...
definePageMeta({
  validate: async (route) => {
    ...
    return !route.params.gameId || (typeof route.params.gameId === 'string' && /^\d+$/.test(route.params.gameId));
  }
})
...
const selectedGameId = ref<number | undefined>(route.params.gameId ? Number(route.params.gameId) : undefined);
