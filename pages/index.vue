...
<template>
  <div class="grid home-content mt-3 pl-3">
    <main class="col-12 md:col-9">
      <Card class="mb-4">
        <template #title>
          Build college football models and tools in a weekend. No scraping. No
          cleanup.
        </template>
        <template #subtitle>
          Clean, structured college football data delivered via API and prebuilt
          packs. Just plug it in and start building.
        </template>
        <template #content>
          <div class="grid mt-4">
            ...
            <div class="col-12 md:col-4">
              ...
              >
                <Button
                  label="📦 Explore the Starter Pack"
                  size="large"
                  class="w-full mb-3 pt-3 pb-3"
                />
              </a>
          ...
          <div class="mt-3">
            <strong
              >✨ Trusted by 5,000+ users making 50M+ API calls each
              season</strong
            ><br />
            💡 500+ supporters on
            <a href="https://www.patreon.com/collegefootballdata">Patreon</a
            ><br />
            📦 150+ supporters on
            <a href="https://collegefootballdata.gumroad.com/l/starter-pack"
              >Gumroad</a
            >
          </div>
        </template>
      ...
      <Message severity="info" :closable="false" class="mb-4">
        A College Basketball API is now in general availability! Use your same
        CFBD API key to access.
        <a href="https://api.collegebasketballdata.com">Check it out!</a>
      </Message>
      <Message severity="warn" :closable="false" class="mb-4">
        CFBD API V2 is now in general availability. CFBD API V1 has officially
        been sunset.
        <a
          href="https://blog.collegefootballdata.com/api-v2-is-now-in-general-availability/"
      ...
      <div class="grid">
        <div class="col-12 md:col-6">
          <Card class="mb-4">
            ...
            <template #content>
              <p class="m-0 mt-3">🔭 <strong>Explore</strong></p>
              <ul class="mt-2">
                <li>
                  🔎 Browse data via the
                  <NuxtLink to="/data">Data tab</NuxtLink>
                </li>
                <li>
                  ⚙️ Access our public API with official clients for
                  <strong>Python</strong> and <strong>TypeScript</strong>
                </li>
                <li>
                  📡 GraphQL API (with live data subscriptions) available to
                  <strong>Patreon Tier 3+</strong>
                </li>
                <li>
                  🔑 API keys are required and work across both Football and
                  Basketball APIs.
              ...
              <p class="m-0 mt-3">
                📦 <strong>Just Released:</strong> The
                <strong>CFBD Starter Pack</strong>
              </p>
              <ul class="mt-2">
                <li>
                  📂 Clean historical data (games, drives, plays, advanced
                  stats)
                </li>
                <li>
                  🧠 12 Jupyter notebooks for modeling, rankings, dashboards,
                  and more
                </li>
                <li>
                  ⚡ Optimized to reduce API usage and accelerate your workflow
                </li>
                <li>
                  👉
                  <a
        ...
        <div class="col-12 md:col-6">
          <Card>
            <template #title> CFBD Blog </template>
            <template #subtitle>
    ...
    <div class="col-12 md:col-3 text-center">
      ...
      <div class="mt-3">
        <a
          href="https://insomnia.rest/run/?label=CFBD&uri=https%3A%2F%2Fapinext.collegefootballdata.com%2Fapi-docs.json"
          target="_blank"
        >
          <Button
            label="Run in Insomnia!"
            class="w-full md:w-8 insomnia-button"
          >
            <template #icon>
              <svg
                width="16px"
...
.insomnia-button {
  ...
  border-color: var(--p-purple-700);
}

.insomnia-button:enabled:hover {
  background: var(--p-purple-700);
  border-color: var(--p-purple-700);
}
